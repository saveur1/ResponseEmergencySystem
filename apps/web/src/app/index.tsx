        ...
        <div className="p-5 font-sans">
            ...
            <div className="grid gap-5">
                {incidents?.map((incident) => (
                    <div
                        key={incident?.id}
                        className={`p-5 rounded-lg bg-white shadow-md border-l-8 transition-transform transform hover:scale-105 ${
                    ...
                    >
                        <div className="flex justify-between mb-2">
                            ...
                            <span className={`px-3 py-1 rounded text-xs font-bold text-white uppercase ${
                                incident?.status === "Completed" ? "bg-green-500" :
                        ...
                        <div className="mb-2 text-gray-600">Reported: {new Date(incident?.timestamp)?.toLocaleString()}</div>
